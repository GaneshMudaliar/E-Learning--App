...
const Footer = () => {
  return (
    <footer className="py-28 bg-light text-black">
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            <h1 className="text-2xl text-blue-500 font-bold">Code4U</h1>
            <p className="text-dark2">
              Code4U is a platform dedicated to empowering aspiring developers.
          ...
          <div className="grid grid-cols-2 gap-10">
            <div className="space-y-4">
              <h1 className="text-2xl font-bold text-blue-500">Courses</h1>
            ...
            <div className="space-y-4">
              <h1 className="text-2xl font-bold text-blue-500">Links</h1>
              <div className="text-dark2">
                <ul className="space-y-2 text-lg">
                  <li className="cursor-pointer hover:text-secondary duration-200">
                    Home
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <div className="flex items-center">
              ...
              />
              <button className="bg-blue-500 text-white font-semibold py-4 px-6 rounded-e-xl">
                Go
              </button>
            </div>
            {/* social icons */}
